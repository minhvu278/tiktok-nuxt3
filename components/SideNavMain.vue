<template>
  <div
      id="SideNavMain"
      :class="route.fullPath === '/' ? 'lg:w-[310px]': 'lg-w[200px]'"
  ...
  >
    <div class="lg:w-full w-[55px] mx-auto">
      ...
      <div class="cursor-pointer">
        <menu-item-follow></menu-item-follow>
      </div>
      ...
      <div class="lg:block hidden text-[11px] text-gray-500">
        <div class="pt-4 px-2">TikTok Shop Contact</div>
        <div class="pt-4 px-2">TikTok for Good Advertise Developers</div>
        <div class="pt-4 px-2">Help Safety Terms Privacy Creator</div>
