<template>
  <div id="TopNav" class="fixed bg-white z-30 flex items-center w-full border-b h-[61px]">
    <div
        ...
        class="flex items-center justify-between w-full px-16 mx-auto"
    >
      <div
          :class="route.fullPath === '/' ? 'w-[80%]': 'lg:w-[20%] w-[70%]' "
      >
        <NuxtLink to="/">
          <img width="115" src="~/assets/images/tiktok-logo.png" alt="tiktok">
        </NuxtLink>
      </div>
      ...
      <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
        ...
        <div class="flex items-center">
          ...
          <Icon class="ml-1 mr-5" name="bx:message-detail" color="#161724" size="27"/>
          <div class="relative">
            <button @click="$event => showMenu = !showMenu" class="mt-1">
              <img class="rounded-full" width="33" src="https://picsum.photos/id/1/300/320" alt="avatar">
            </button>
            <div
                v-if="showMenu"
                id="PopupMenu"
            ...
            >
              ...
              <div class="flex items-center justify-start py-3 px-2 hover:bg-gray-100 border-t cursor-pointer">
